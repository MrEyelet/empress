...
class AppearElements {
  ...
  showElements() {
    ...
    this.tlShowElements.from(".illustration-hero__circle-group", { duration: 0.75, scale: 0, opacity: 0, transformOrigin: "center", ease: Power1.easeOut }, "=-1.5")
    this.tlShowElements.from(".illustration-hero__inner", { duration: 0.75, scale: 1.1, opacity: 0, ease: Power4.easeOut }, "=-0.75")
    setTimeout(() => {
